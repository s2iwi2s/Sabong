...
public class TokenProvider {
    ...
    public TokenProvider(AppConfigProperties appConfig) {
        byte[] keyBytes;
        AppConfigProperties.Jwt jwt = appConfig.getJwt();
...
//        Authentication auth = new UsernamePasswordAuthenticationToken(applicationProperties.getJhipsterAuthUser(), applicationProperties.getJhipsterAuthPass(), Collections.singleton(authority));
